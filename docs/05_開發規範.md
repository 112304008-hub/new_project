  ...
  deploy:
    ...
    steps:
      ...
      - name: Build Docker image
        run: docker build -t fortune-ticker:latest .
      - name: Push to registry
        run: |
          docker tag fortune-ticker:latest ghcr.io/user/fortune-ticker:latest
          docker push ghcr.io/user/fortune-ticker:latest
```
